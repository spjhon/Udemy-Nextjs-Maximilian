...
//Esta funcion loader esta pensada para comunicarse con cloudify y hacer transformaciones ahi
//Este image uploader manipula la url que se envia
function imageLoader(config: configProps) {
